...
// struct LINUX_FILE *next_file_struct_for_tmp = NULL; // ?????????????????????????????????????????????????????
// struct LINUX_FILE *next_file_struct_for_output = NULL; // ?????????????????????????????????????????????????????

struct LINUX_FILE next_file_struct_for_tmp = &tmp_file_struct->next_file;  // ?????????????????????????????????????????????
struct LINUX_FILE next_file_struct_for_output = &output_file_struct->next_file;  // ?????????????????????????????????????????????
